...
import uk.co.deanwild.flowtextview.helpers.*;
...
public class ClickHandler implements View.OnTouchListener{
    ...
    private final uk.co.deanwild.flowtextview.helpers.SpanParser mSpanParser;
    private OnLinkClickListener mOnLinkClickListener;

    private double distance = 0;
    private float x1,y1,x2,y2 = 0f;

    public ClickHandler(uk.co.deanwild.flowtextview.helpers.SpanParser spanParser) {
