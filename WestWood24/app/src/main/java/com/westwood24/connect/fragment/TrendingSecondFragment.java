...
public class TrendingSecondFragment extends Fragment implements WebserviceCall.WebserviceResponse {
...
//Refreshing data on server
    ...
    public static void callTopNewsDetailApi() {
        ...
        try {
            ...
            requestParams.put("filtertype", "trending");
    ...
    public void success(String url, String apiName, String response) {
        ...
        try {
            ...
            if (response_code.equals("200")) {
                ...
                {
                   /* adapter = new VideoImageAdapter(getActivity(), list,"second");
