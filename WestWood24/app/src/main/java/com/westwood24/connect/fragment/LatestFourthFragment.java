...
public class LatestFourthFragment extends Fragment implements WebserviceCall.WebserviceResponse {
    ListView mVideoLv;
...
//Refreshing data on server
    ...
    private void callLatestDetailApi() {
    ...
    public void success(String url, String apiName, String response) {
        ...
        try {
            ...
            /*    adapter = new VideoImageAdapter(getActivity(), list,"fourth");
